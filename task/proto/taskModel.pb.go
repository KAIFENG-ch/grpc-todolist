...
func (x *TaskModel) GetStartAt() int64 {
	if x != nil {
		return x.StartAt
	}
	return 0
...
func (x *TaskModel) GetEndAt() int64 {
	if x != nil {
		return x.EndAt
	}
	return 0
...
var file_taskModel_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcb, 0x01, 0x0a, 0x09, 0x54, 0x61, 0x73,
	...
	0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_taskModel_proto_goTypes = []interface{}{
	(*TaskModel)(nil), // 0: proto.TaskModel
}
